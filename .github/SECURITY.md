...
1. **GitHub Security Advisories (Preferred)**: Navigate to the [Melofy Security Tab](https://github.com/Jenesh11/melofy/security/advisories) on GitHub and select **"Report a vulnerability"** to draft a private advisory.
2. **Email**: Contact maintainers directly at `pateljenesh079@gmail.com`.
